...
namespace sistemcommerce.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //   var user = CreateUser(); se usara el nuestro 
                ...
                {
                    //admin cree usuarios admin sino solo se crean clientes
